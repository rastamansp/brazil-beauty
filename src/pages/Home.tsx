  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                Encontre profissionais premium, modelos, tradutoras e massagistas de alta qualidade com o Brasil Beauty
              </p>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Por que Brasil Beauty?</h2>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto text-center text-muted-foreground">
          <p>&copy; 2025 Brasil Beauty. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
