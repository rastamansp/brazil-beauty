...
const TestChatbot = () => {
  ...
  const headerName = selectedJourney ? "John — Concierge Brasil Beauty" : undefined;
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left space-y-6 animate-fade-in">
            <div className="inline-block">
              <span className="bg-primary/20 text-primary px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm">
                🤖 Teste do Chatbot Brasil Beauty
              </span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-bold text-foreground leading-tight">
              Teste o
              <span className="block text-primary animate-gradient">Chatbot Brasil Beauty</span>
            </h1>
            
            <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              Experimente diferentes jornadas de conversação e veja como nosso chatbot inteligente 
              guia usuários desde o primeiro contato até encontrar profissionais premium.
            </p>
